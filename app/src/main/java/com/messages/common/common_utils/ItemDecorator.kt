...
data class ItemDecorator(
    ...
    @ColorInt
    private var mBgColorFromStartToEnd = recyclerView.context.getColorForId(android.R.color.transparent)

    @ColorInt
    private var mBgColorFromEndToStart = recyclerView.context.getColorForId( android.R.color.transparent)
